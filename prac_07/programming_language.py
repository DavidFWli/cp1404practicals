...
def run_tests():
    ...
    ruby = ProgrammingLanguage("Ruby", "Dynamic", True, False, 1995)  # Assuming Ruby doesn't have pointer arithmetic
    python = ProgrammingLanguage("Python", "Dynamic", True, False,
                                 1991)  # Assuming Python doesn't have pointer arithmetic
    visual_basic = ProgrammingLanguage("Visual Basic", "Static", False, False,
                                       1991)  # Assuming Visual Basic doesn't have pointer arithmetic
    c_language = ProgrammingLanguage("C", "Static", False, True, 1972)  # Assuming C has pointer arithmetic
